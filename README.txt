...
Users can:
  Search for recipes by keywords or browse by category
	...
	Use voice commands to read the next instruction, read the 
		previous instruction, or repeat the current instruction
...
Improvements since Beta Release:
	Users can now create accounts from the app, and log in and 
